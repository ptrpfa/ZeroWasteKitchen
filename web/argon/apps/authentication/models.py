...
class Userdietrestriction(models.Model):
    mappingid = models.AutoField(db_column='MappingID', primary_key=True)
    userid = models.ForeignKey(User, models.CASCADE, db_column='UserID', related_name='authentication_userdietrestrictions')
    restrictionid = models.ForeignKey(Dietrestriction, models.CASCADE, db_column='RestrictionID')
...
class Userrecipe(models.Model):
    mappingid = models.AutoField(db_column='MappingID', primary_key=True)
    userid = models.ForeignKey(User, models.CASCADE, db_column='id', related_name='user_recipes')
    recipeid = models.ForeignKey(Recipe, models.CASCADE, db_column='RecipeID')
